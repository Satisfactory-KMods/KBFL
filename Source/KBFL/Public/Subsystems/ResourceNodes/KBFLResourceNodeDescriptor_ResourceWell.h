...
public:
	...
	TSubclassOf<AFGResourceNodeFrackingCore> mFrackingCoreClass = LoadClass<AActor>(
		nullptr, TEXT("/KBFL/ResourceNodeActors/BaseNode_FrackingCore.BaseNode_FrackingCore_C"));

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Resource Node")
	TSubclassOf<AFGResourceNodeFrackingSatellite> mFrackingSatelliteClass = LoadClass<AActor>(
		nullptr, TEXT("/KBFL/ResourceNodeActors/BaseNode_FrackingSat.BaseNode_FrackingSat_C"));

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Resource Node")
	TSubclassOf<AActor> mCrackClass = LoadClass<
		AActor>(nullptr, TEXT("/KBFL/ResourceNodeActors/SMA_Crack.SMA_Crack_C"));;
