...
class KBFL_API UKBFLAssetDataSubsystem: public UGameInstanceSubsystem {
	...
	public:
		...
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetItemsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UFGItemDescriptor>>& Out_Items, bool UseNativeCheck = false);
		...
		/** Get All Items that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetSchematicsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UFGSchematic>>& Out_Items, bool UseNativeCheck = false);
		...
		/** Get All Items that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetRecipesOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UFGRecipe>>& Out_Items, bool UseNativeCheck = false);
		...
		/** Get All Items that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetBuildableOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<AFGBuildable>>& Out_Items, bool UseNativeCheck = false);
		...
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetObjectsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UObject>>& Out_Items, bool UseNativeCheck = false);

		template<class T>
		void GetObjectsOfChilds_Internal(TArray<UClass*> Childs, TArray<TSubclassOf<T>>& Out_Items, bool UseNativeCheck = false);


		/** Get All DriveablePawns that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetDriveablePawnsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<AFGDriveablePawn>>& Out_Items, bool UseNativeCheck = false);


		/** Get All Holograms that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetHologramsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<AFGHologram>>& Out_Items, bool UseNativeCheck = false);


		/** Get All tModModules that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetModModulesOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UModModule>>& Out_Items, bool UseNativeCheck = false);


		/** Get All CDOHelpers that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetCDOHelpersOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UKBFL_CDOHelperClass_Base>>& Out_Items, bool UseNativeCheck = false);


		/** Get All ResourceDescriptors that hit the Child Classes  */
		UFUNCTION(BlueprintCallable, Category="Asset Data Subsystem")
		void GetResourceDescriptorsOfChilds(TArray<UClass*> Childs, TArray<TSubclassOf<UKBFLActorSpawnDescriptorBase>>& Out_Items, bool UseNativeCheck = false);
...
template<class T>
void UKBFLAssetDataSubsystem::GetObjectsOfChilds_Internal(const TArray<UClass*> Childs, TArray<TSubclassOf<T>>& Out_Items, bool UseNativeCheck) {
	if(!bWasInit) {
