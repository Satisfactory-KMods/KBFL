...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Instanced,
		meta = ( EditCondition = mSchematicDependenciesOverride ), Category="FG Schematic")
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite,
		meta = ( EditCondition = mDependenciesBlocksSchematicAccessOverride ), Category="FG Schematic")
