...
FKBFLCDOInformation UKBFLGameInstanceModule::GetCDOInformationFromPhase_Implementation(
	ELifecyclePhase Phase, bool& HasPhase)
{
...
{
	FindAllCDOs();
	if (UKBFLContentCDOHelperSubsystem* CDOHelperSubsystem = GetWorld()->GetGameInstance()->GetSubsystem<
