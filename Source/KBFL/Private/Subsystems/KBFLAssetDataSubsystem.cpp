...
TSubclassOf<UFGBuildingDescriptor> UKBFLAssetDataSubsystem::GetDescForBuildable(
	TSubclassOf<AFGBuildable> BuildableClass)
{
	for (UClass* ItemClass : mAllFoundedItems)
	{
		...
		{
			TSubclassOf<AFGBuildable> TestBuildableClass = UFGBuildingDescriptor::GetBuildableClass(
				ItemClass);
...
TSubclassOf<UFGVehicleDescriptor> UKBFLAssetDataSubsystem::GetDescForVehicle(TSubclassOf<AFGVehicle> Class)
{
	for (UClass* ItemClass : mAllFoundedItems)
	{
		...
		{
			TSubclassOf<AFGVehicle> TestBuildableClass = UFGVehicleDescriptor::GetVehicleClass(
				ItemClass);
